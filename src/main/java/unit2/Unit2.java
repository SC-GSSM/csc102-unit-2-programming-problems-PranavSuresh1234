...
public class Unit2 {
    ...
    public static void main(String[] args) {
        System.out.println(concatenateStrings("x", "y"));
        ...
        System.out.println(roundValue(3.6));
        System.out.println(getSubstring("pranav", 3, 5));
        System.out.println(getAbsoluteValue(-42));
